...
def create_app(test_config=None):
    ...
    def get_quiz():
        ...
        if request.data:
            ...
            if (('quiz_category' in search and
                 'id' in search['quiz_category']) and
                    'previous_questions' in search):
                ...
                if (search['quiz_category']['id'] == 0):
                    ...
                    questions_list = Question.query.filter_by(
                      category=search['quiz_category']['id']).filter(
                        Question.id.notin_(search["previous_questions"])).all()
                ...
                if question_list_length > 0:
                    question = {
                      ...
                      "question": Question.format(
                        questions_list[random.randrange(
                          0, question_list_length)])
                      }
                else:
                    question = {
                      "success": True,
